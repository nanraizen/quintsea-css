(function (root, factory) {
	if (typeof define === 'function' && define.amd) {
		...
		root.Quintsea = factory();
	}
}(typeof self !== 'undefined' ? self : this, function () {
	'use strict';

	function initQuintsea() {
		// DISABLE HREF #
		...
		document.querySelectorAll('[data-tooltip-text]').forEach(tooltip => {
			...
			tooltip.addEventListener('mouseleave', () => {
				...
				const isCopied = tooltipText && tooltipText.textContent.startsWith('Copied');
	...
	if (document.readyState === 'loading') {
		document.addEventListener('DOMContentLoaded', initQuintsea);
	} else {
		initQuintsea();
	}

/*!
 * Quintsea CSS v0.3.4 (https://quintsea.nanraizen.me)
 * (c) 2025 | MIT License
 */
! function (e, t) {
    ...
    function e() {
        ...
        function a(e, t = null) {
            navigator.clipboard.writeText(e).then(() => {
                ...
                a.className = "glyph color green", a.textContent = "done_all";
                let l = document.createElement("span");
                l.textContent = "Copied to Clipboard", e.append(a, l), document.body.appendChild(e), setTimeout(() => e.classList.add("show"), 100), setTimeout(() => {
        ...
        document.querySelectorAll("a[href]").forEach(t => {
            let a = t.getAttribute("href"),
                l = new URL(a, window.location.origin),
                o = l.hostname === e.hostname && l.pathname + l.search === e.pathname + e.search;
            o && t.addEventListener("click", e => e.preventDefault())
            ...
            if (t) {
                ...
                let l = () => {
                    let e = +t.min || 0,
                        ...
                        o = +t.value,
                        r = t.offsetWidth;
                    a.textContent = o, a.style.left = (o - e) / (l - e) * (r - 16) + 8 + "px"
                };
            ...
            e.addEventListener("mouseenter", () => {
                ...
                let l = e.querySelector(".tooltip-text"),
                    o = l && l.textContent.startsWith("Copied");
                l && (a = setTimeout(() => {
            ...
            e.addEventListener("click", () => {
                let t = e.closest(".copyGroup"),
                    l = t.querySelector('[data-copy="content"]');
                if (!l) return;
                let o = "INPUT" === l.tagName || "TEXTAREA" === l.tagName ? l.value : l.textContent;
                a(o, l)
            })
        ...
        let l = document.documentElement,
            o = document.querySelectorAll("[data-theme-trigger]"),
            r = window.matchMedia("(prefers-color-scheme: dark)");

        function s(e) {
            let t = e;
            if ("light" === e) l.setAttribute("data-theme", "light");
            else if ("dark" === e) l.setAttribute("data-theme", "dark");
            else {
                let a = r.matches ? "dark" : "light";
                l.setAttribute("data-theme", a), t = "system"
            }
            o.forEach(e => {
                e.classList.toggle("active", e.dataset.themeTrigger === t)
            })
        }
        s(localStorage.getItem("theme") || "system"), o.forEach(e => {
            e.addEventListener("click", () => {
                let t = e.dataset.themeTrigger;
                if ("toggle" === t) {
                    let a = l.getAttribute("data-theme") || (r.matches ? "dark" : "light"),
                        o = "dark" === a ? "light" : "dark";
                    localStorage.setItem("theme", o), s(o)
                } else localStorage.setItem("theme", t), s(t)
            })
        }), r.addEventListener("change", () => {
            "system" === localStorage.getItem("theme") && s("system")
        })
    }
    return "loading" === document.readyState ? document.addEventListener("DOMContentLoaded", e) : e(), e
});
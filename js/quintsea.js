...
document.addEventListener("DOMContentLoaded", () => {
    ...
    function a(e, t = null) {
        navigator.clipboard.writeText(e).then(() => {
            ...
            l.textContent = "Copied to Clipboard", e.appendChild(a), e.appendChild(l), document.body.appendChild(e), setTimeout(() => e.classList.add("show"), 100), setTimeout(() => {
    ...
    document.querySelectorAll("a[href]").forEach(t => {
        ...
        e.addEventListener("click", () => {
            ...
            if (t) a("INPUT" === t.tagName || "TEXTAREA" === t.tagName ? t.value : t.textContent, t)
        })
